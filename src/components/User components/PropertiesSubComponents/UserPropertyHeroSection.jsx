...
const UserPropertyHeroSection = () => {
  const {bedroomCount, decrementBedroom, incrementBedroom, setLocation, setType, setBed} = useGlobalContext();
       ...
       <div className="search-properties">
        <form action="" className='d-flex align-items-center' onSubmit={handleSearch} id='form1'>
         <div className="search-location">
            ...
            <input type='text' className='text-dark' placeholder='eg. Lagos' value={loc} onChange={(e)=>setLoc(e.target.value)} />
         </div>
         ...
         <div className="search-location">
            ...
            <input type='text' className='text-dark' placeholder='eg. land, house' value={spec} onChange={(e)=>setSpec(e.target.value)} />
         </div>
